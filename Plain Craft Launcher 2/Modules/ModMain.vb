...
#Region "帮助"
    ...
    Public Class HelpEntry
        ...
        Public Sub New(FilePath As String)
            RawPath = FilePath
            If Not FileUtils.Exists(FilePath) Then Throw New FileNotFoundException(GetLang("LangModMainExceptionNoFileFound", FilePath), FilePath)
        ...
        Try
            ...
            If GiveUpDistance > 2500 Then
                ...
                Select Case RandomInteger(0, 3)
                    Case 0
                        Hint(GetLang("LangModMainAprilFoolTipA"), HintType.Red)
                    Case 1
                        Hint(GetLang("LangModMainAprilFoolTipB"), HintType.Red)
                    Case 2
                        Hint(GetLang("LangModMainAprilFoolTipC"), HintType.Red)
                    Case 3
                        Hint(GetLang("LangModMainAprilFoolTipD"), HintType.Red)
                End Select
            End If
