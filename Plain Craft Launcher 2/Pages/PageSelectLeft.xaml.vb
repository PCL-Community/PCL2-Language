    ...
    Private Sub McFolderListUI()
        Try
            ...
            For Each Folder As McFolder In McFolderList.ToArray
                ...
                End Select
                If (Folder.Type = McFolder.Types.Vanilla OrElse Folder.Type = McFolder.Types.RenamedVanilla) AndAlso Folder.Location = Paths.Base & ".minecraft\" AndAlso McFolderList.IsSingle Then CType(ContMenu.FindName("Delete"), MyMenuItem).Header = GetLang("LangSelectEmpty")
                '注册事件
